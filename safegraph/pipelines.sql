...
CREATE PIPELINE places_patterns_monthly AS
...
CREATE PIPELINE places_patterns_weekly_old AS
...
CREATE PIPELINE places_patterns_weekly_new AS
...
CREATE PIPELINE social_distancing AS
...
CREATE PIPELINE tx_daily_deposits_zip AS
...
CREATE PIPELINE tx_daily_spend_brand AS
...
CREATE PIPELINE tx_daily_spend_walmart AS
...
CREATE PIPELINE tx_daily_spend_zip_mcc AS
...
CREATE PIPELINE tx_daily_spend_zip AS
